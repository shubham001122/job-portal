    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                ...
                <div class="banner-btn mt-5"><a href="{{ route('account.jobs') }}" class="btn btn-primary mb-4 mb-sm-0">Explore Now</a></div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
     ...
     <div class="col-lg-4 col-xl-3 col-md-6">
        <div class="single_catagory">
            <a href="{{ route('account.category_wise',$category->id) }}"><h4 class="pb-2">{{ $category->name }}</h4></a>
                            ...
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="bg-light p-3 border">
                                        ...
                                        <p class="mb-0">
                                            <span class="fw-bolder"><i class="fa fa-clock-o"></i></span>
                                            <span class="ps-1">{{ $latest_job->job_type->name }}</span>
                                        </p>
                                        <p class="mb-0">
                                            <span class="fw-bolder"><i class="fa fa-usd"></i></span>
