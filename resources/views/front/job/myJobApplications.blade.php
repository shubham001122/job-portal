                ...
                <div class="card border-0 shadow mb-4 p-3">
                 @if(Session::has('deleted'))
                    <div class="alert alert-success">
                        <strong>Success!</strong> <p>{{Session::get('deleted') }}</p> 
                      </div>
                    @endif
                                ...
                                <tr class="active">
                                    ...
                                    <td>
                                        <div class="action-dots float-end">
                                            ...
                                            <li><a class="dropdown-item" href="{{ route('jobDetail',$applied_job->job_id) }}"> <i class="fa fa-eye" aria-hidden="true"></i> View</a></li>    
                                            <li><a class="dropdown-item" href="#" onclick="removeJob({{ $applied_job->id }})" ><i class="fa fa-trash" aria-hidden="true"></i> Remove</a></li>
                    ...
                    You haven't applied for any jobs yet.</p>
                    @endif
