...
$.ajax({
    ...
    if(errors.name)
         {
    $("#name").addClass('is-invalid').siblings()
    ...
    if(errors.email)
        ...
        $("#email").addClass('is-invalid').siblings()
        .addClass('invalid-feedback').html(errors.email);
    }
    else
    {
        $("#email").removeClass('is-invalid').siblings()
        .removeClass('invalid-feedback').html("");
    ...
    if(errors.password)
        ...
        $("#password").addClass('is-invalid').siblings()
        .addClass('invalid-feedback').html(errors.password);
    }

    else
    {
        $("#password").removeClass('is-invalid').siblings()
        .removeClass('invalid-feedback').html("");
    ...
    if(errors.confirm_password)
        ...
        $("#confirm_password").addClass('is-invalid').siblings()
